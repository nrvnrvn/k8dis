/*
Copyright 2023 The k8dis Authors.
...
//+kubebuilder:webhook:path=/mutate-k8s-nrvn-cc-v1-redis,mutating=true,failurePolicy=fail,sideEffects=None,groups=k8s.nrvn.cc,resources=redis,verbs=create;update,versions=v1,name=mredis.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-k8s-nrvn-cc-v1-redis,mutating=false,failurePolicy=fail,sideEffects=None,groups=k8s.nrvn.cc,resources=redis,verbs=create;update,versions=v1,name=vredis.kb.io,admissionReviewVersions=v1
